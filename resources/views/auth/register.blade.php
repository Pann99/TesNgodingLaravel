<x-guest-layout>
<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-400 via-blue-500 to-blue-700">
    
    <div class="w-full h-screen bg-white flex overflow-hidden" style="border-radius: 0;">
        <!-- LEFT: Slider Panel -->
            ...
            <div class="flex-1 flex items-center justify-center">
                <div class="relative w-full">
                    ...
                    <div class="slide flex flex-col items-center text-center" data-slide="0">
                        ...
                        <h2 class="text-white text-2xl font-bold mb-2">Mulai Sekarang!</h2>
                        <p class="text-blue-200 text-sm leading-relaxed">Daftar gratis dan langsung<br/>catat semua tugasmu.</p>
                    </div>
                    ...
                    <div class="slide hidden flex-col items-center text-center" data-slide="1">
                        <svg viewBox="0 0 220 180" class="w-48 mb-6" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <rect x="60" y="75" width="14" height="12" rx="3" fill="#DBEAFE"/>
                            <rect x="80" y="75" width="14" height="12" rx="3" fill="#DBEAFE"/>
                            <rect x="100" y="75" width="14" height="12" rx="3" fill="#3B82F6"/>
                            <rect x="120" y="75" width="14" height="12" rx="3" fill="#DBEAFE"/>
                            <rect x="140" y="75" width="14" height="12" rx="3" fill="#DBEAFE"/>
                            <rect x="60" y="95" width="14" height="12" rx="3" fill="#DBEAFE"/>
                            <rect x="80" y="95" width="14" height="12" rx="3" fill="#3B82F6"/>
                            <rect x="100" y="95" width="14" height="12" rx="3" fill="#DBEAFE"/>
                            <rect x="120" y="95" width="14" height="12" rx="3" fill="#DBEAFE"/>
                            <rect x="140" y="95" width="14" height="12" rx="3" fill="#DBEAFE"/>
                            <rect x="60" y="115" width="14" height="12" rx="3" fill="#10B981"/>
                            <rect x="80" y="115" width="14" height="12" rx="3" fill="#DBEAFE"/>
                            <rect x="100" y="115" width="14" height="12" rx="3" fill="#DBEAFE"/>
                            <rect x="120" y="115" width="14" height="12" rx="3" fill="#3B82F6"/>
                            <rect x="140" y="115" width="14" height="12" rx="3" fill="#DBEAFE"/>
                        ...
                        <h2 class="text-white text-2xl font-bold mb-2">Pantau Progresmu!</h2>
                        <p class="text-blue-200 text-sm leading-relaxed">Kelola semua tugas dengan<br/>filter status yang mudah.</p>
                    </div>
                    ...
                    <div class="slide hidden flex-col items-center text-center" data-slide="2">
                        ...
                        <p class="text-blue-200 text-sm leading-relaxed">Dashboard lengkap memantau<br/>semua pencapaian tugasmu.</p>
                    </div>
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-10">
            <div class="w-full max-w-sm">
                ...
                <h2 class="text-3xl font-bold text-blue-600 mb-1">Daftar</h2>
                <p class="text-gray-400 text-sm mb-6">
                    Sudah punya akun?
                    <a href="{{ route('login') }}" class="text-blue-500 font-semibold hover:underline">Masuk di sini</a>
                </p>
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-4">
                    ...
                    <div class="relative">
                        <input type="text" name="name" value="{{ old('name') }}"
                            ...
                            class="w-full px-4 py-3 pr-10 border-b @error('name') border-red-400 @else border-gray-200 @enderror text-gray-700 text-sm focus:outline-none focus:border-blue-500 transition bg-transparent"/>
                    ...
                    <div class="relative">
                        ...
                        <button type="button" onclick="togglePass('reg-password','eye-reg')"
                    ...
                    <div class="relative">
                        <input type="password" name="password_confirmation" id="reg-confirm"
                            ...
                            class="w-full px-4 py-3 pr-10 border-b border-gray-200 text-gray-700 text-sm focus:outline-none focus:border-blue-500 transition bg-transparent"/>
                        <button type="button" onclick="togglePass('reg-confirm','eye-confirm')"
                            class="absolute right-2 top-3 text-gray-300 hover:text-gray-500 transition">
